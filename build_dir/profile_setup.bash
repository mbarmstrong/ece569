...
echo "generating profile2.txt"
# make sure the input0.raw, input1.raw and output.raw files are in the build_dir directory. 
nvprof --log-file profile2.txt ./TiledMatrixMultiplication_Solution -e output.raw -i input0.raw,input1.raw -t vector > vout6.txt

echo "generating profile2.timeline"
nvprof -o profile2.timeline ./TiledMatrixMultiplication_Solution -e output.raw -i input0.raw,input1.raw -t vector > vout7.txt

echo "generating profiledata2 for nvvp"
nvprof --export-profile profiledata2 ./TiledMatrixMultiplication_Solution -e output.raw -i input0.raw,input1.raw -t vector > vout8.txt
